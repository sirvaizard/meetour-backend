...
export default class CreateUser {
    ...
    async execute (name: string, email: string, password: string, cpf: string, birth: Date, bio: string) {
        ...
        return this.userRepository.create(name, email, password_hash, cpf, birth, bio)
    }
}
